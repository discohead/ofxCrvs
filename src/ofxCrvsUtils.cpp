...
glm::vec2 Utils::transform(glm::vec2 vector, glm::vec2 center, glm::vec2 scale,
                           glm::vec2 translation, float rotationDegrees) {
...
std::vector<glm::vec2> Utils::transform(std::vector<glm::vec2> vector,
...
glm::vec2 Utils::clipped(glm::vec2 vector, float xMin, float xMax, float yMin,
                         float yMax) {
